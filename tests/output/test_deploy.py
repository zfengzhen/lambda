...
def test_wrap_with_password_contains_hash():
    ...
    from output.deploy import wrap_with_password
...
def test_send_telegram_missing_env(monkeypatch):
    ...
    from output.deploy import send_telegram
...
def test_send_telegram_calls_api(monkeypatch):
    ...
    monkeypatch.setattr("output.deploy.requests.post", mock_post)
